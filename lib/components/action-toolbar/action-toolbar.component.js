...
function (_React$Component) {
  ...
  _createClass(ActionToolbar, [{
    ...
    value: function render() {
      return _react.default.createElement(_actionToolbar.StyledActionToolbar, _extends({
        className: this.props.className
      }, (0, _tags.default)('action-toolbar', this.props)), _react.default.createElement(_actionToolbar.StyledActionToolbarTotal, null, _react.default.createElement("strong", {
        "data-element": "total"
      }, this.state.total), "\xA0", _i18nJs.default.t('action_toolbar.selected', {
        defaultValue: 'Selected'
      })), _react.default.createElement(_actionToolbar.StyledActionToolbarActions, {
        disabled: !this.isActive()
