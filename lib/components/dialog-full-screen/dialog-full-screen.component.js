...
function (_Modal) {
  ...
  function DialogFullScreen(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "headingRef", _react.default.createRef());
    ...
    _defineProperty(_assertThisInitialized(_this), "dialogTitle", function () {
      ...
      return _react.default.createElement(_fullScreenHeading.default, {
        hasContent: title,
        ref: _this.headingRef
  ...
  _createClass(DialogFullScreen, [{
    ...
    value: function componentDidUpdate() {
      _get(_getPrototypeOf(DialogFullScreen.prototype), "componentDidUpdate", this).call(this);
    ...
    key: "updateHeadingHeight",
    value: function updateHeadingHeight() {
      if (this.headingRef.current && this.state.headingHeight !== this.headingRef.current.clientHeight) {
        this.setState({
          headingHeight: this.headingRef.current.clientHeight
        });
      }
    }
    /**
    ...
    get: function get() {
      ...
      return _react.default.createElement(_dialogFullScreen.default, {
        ref: function ref(d) {
          _this2._dialog = d;
        },
        "data-element": "dialog-full-screen"
      }, this.dialogTitle(), _react.default.createElement(_content.default, {
...
_defineProperty(DialogFullScreen, "state", {
