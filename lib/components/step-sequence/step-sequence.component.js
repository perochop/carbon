...
var StepSequence = function StepSequence(props) {
  return _react.default.createElement(_stepSequence.default, _extends({
    "data-component": "step-sequence"
  }, props), _react.default.Children.map(props.children, function (child) {
