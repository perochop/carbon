...
var _confirm = _interopRequireDefault(require("./confirm.style"));
...
function (_Dialog) {
  ...
  _createClass(Confirm, [{
    ...
    value: function additionalContent() {
      return _react.default.createElement(_confirm.default, null, _react.default.createElement(_button.default, {
    ...
    get: function get() {
      return (0, _classnames.default)(_get(_getPrototypeOf(Confirm.prototype), "mainClasses", this));
    }
  }]);
...
Confirm.defaultProps = _objectSpread({}, _dialog.default.defaultProps, {
  size: 'extra-small',
  showCloseIcon: false
});
Confirm.propTypes = _objectSpread({}, _dialog.default.propTypes, {
