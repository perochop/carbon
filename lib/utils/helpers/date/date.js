...
var DateHelper = {
   ...
   * @return {Moment}
   */
  todayFormatted: function todayFormatted() {
  ...
  */
  ...
  formatDateToCurrentLocale: function formatDateToCurrentLocale(value) {
    var defaultDateFormat = 'DD/MM/YYYY';

    var visibleFormat = _i18nJs.default.t('date.formats.javascript', {
