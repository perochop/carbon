...
var withUniqueIdProps = function withUniqueIdProps(WrappedComponent) {
  var WithUniqueIdProps =
  /*#__PURE__*/
  function (_React$Component) {
    _inherits(WithUniqueIdProps, _React$Component);

    function WithUniqueIdProps() {
      ...
      _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(WithUniqueIdProps)).call.apply(_getPrototypeOf2, [this].concat(args)));
  ...
  var Component = _react.default.forwardRef(function (props, ref) {
    return _react.default.createElement(WithUniqueIdProps, _extends({}, props, {
      forwardedRef: ref
    }));
  });

  var displayName = WrappedComponent.displayName || WrappedComponent.name || 'WithUniqueIdProps(Unknown)';
