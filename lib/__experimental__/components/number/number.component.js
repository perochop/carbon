...
function (_React$Component) {
  ...
  function Number() {
    ...
    _defineProperty(_assertThisInitialized(_this), "handleOnChange", function (event) {
      if (isValidNumber(event.target.value) && _this.props.onChange) {
        _this.props.onChange(event, _this.props);
      } else {
        event.target.value = _this.props.value || null;
        event.target.setSelectionRange(_this.selectionStart, _this.selectionEnd);
      }
    });
  ...
  _createClass(Number, [{
    ...
    value: function render() {
      return _react.default.createElement(_textbox.default, _extends({}, this.props, {
...
Number.propTypes = _objectSpread({}, _textbox.default.propTypes);
var _default = Number;
