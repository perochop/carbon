...
function (_React$Component) {
  ...
  function Input() {
    ...
    _defineProperty(_assertThisInitialized(_this), "handleFocus", function (ev) {
      ...
      if (_this.props.type === 'text') selectTextOnFocus(_this.input);
    });
    ...
    _defineProperty(_assertThisInitialized(_this), "handleChange", function (ev) {
      ...
      _this.handleDeferred(ev);
    });

    _defineProperty(_assertThisInitialized(_this), "handleDeferred", function (_ref) {
  ...
  _createClass(Input, [{
    ...
    value: function render() {
      var _this$props = this.props,
          ...
          onChangeDeferred = _this$props.onChangeDeferred,
          props = _objectWithoutProperties(_this$props, ["inputRef", "onChangeDeferred"]);
