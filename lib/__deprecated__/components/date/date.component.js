...
var _weekday = _interopRequireDefault(require("./weekday/weekday.component"));
...
function (_React$Component) {
  ...
  function Date(args) {
    ...
    _defineProperty(_assertThisInitialized(_this), "openDatePicker", function () {
      ...
      } else if (_this.props.allowEmptyValue) {
        _this.setState({
          datePickerValue: _date2.default.stringToDate(today)
        });
      }
    });
  ...
  _createClass(Date, [{
    ...
    */
    ...
    value: function renderDatePicker() {
      ...
      }, _react.default.createElement(_dayPicker.default, null, _react.default.createElement(_reactDayPicker.default, _extends({}, this.datePickerProps, {
