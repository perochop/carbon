...
function (_React$Component) {
  ...
  function Dropdown() {
    ...
    _defineProperty(_assertThisInitialized(_this), "deprecatedWarnTriggered", false);
  ...
  _createClass(Dropdown, [{
    ...
    value: function render() {
      if (!this.deprecatedWarnTriggered) {
        ...
        (0, _warnAsDeprecated.default)('DropDown, DropdownFilter and DropdownFilterAjax', 'carbon-react/lib/_experimental_/components/select and carbon-react/lib/_experimental_/components/select-async');
      }
